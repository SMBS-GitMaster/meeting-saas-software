...
interface IBusinessPlanVisionThreeYearProps {
  tileId: () => Id
  getData: () => Pick<
    IBusinessPlanViewData,
    | 'pageState'
...
export const BusinessPlanVisionThreeYearTile = observer(
  (props: IBusinessPlanVisionThreeYearProps) => {
    ...
    const getTileData = useComputed(
      ...
      { name: 'businessPlanVisionThreeYearTile-getTileData' }
    )
    ...
    const getIsEditingDisabled = useComputed(
      ...
      { name: 'businessPlanVisionThreeYearTile-getIsEditingDisabled' }
    )
    ...
    const getListCollection = useComputed(
          ...
          (listCollection) => {
            return (
              listCollection.listType ===
                EBusinessPlanListCollectionListType.NumberedList ||
              listCollection.listType ===
                EBusinessPlanListCollectionListType.BulletedList
            )
          }
        )
      ...
      {
        name: 'businessPlanVisionThreeYearTile-getListCollectionIdsForNumberedOrBulletedListCollections',
      }
    )
        ...
        <BusinessPlanTileHeader
          ...
          renderMenuOptions={{
            ...
            goalOptions: {
              ...
              goalCustomTerm: terms.quarterlyGoals.singular,
              getListCollection,
            },
          }}
