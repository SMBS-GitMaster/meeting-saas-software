...
interface IBusinessPlanGoalsTileProps {
  tileId: () => Id
  getData: () => Pick<
    IBusinessPlanViewData,
    | 'pageState'
...
export const BusinessPlanGoalsTile = observer(
  (props: IBusinessPlanGoalsTileProps) => {
    ...
    const getTileData = useComputed(
      ...
      { name: 'businessPlanGoalsTile-getTileData' }
    )
    ...
    const getIsEditingDisabled = useComputed(
      ...
      { name: 'businessPlanGoalsTile-getIsEditingDisabled' }
    )
    ...
    const getListCollection = useComputed(
        ...
        const listCollection = getTileData().listCollections.nodes.find(
          (listCollection) => {
            return (
              ...
              EBusinessPlanListCollectionListType.GoalsList
            )
          }
        )
      ...
      {
        name: 'businessPlanGoalsTile-getListCollection',
      }
    )
