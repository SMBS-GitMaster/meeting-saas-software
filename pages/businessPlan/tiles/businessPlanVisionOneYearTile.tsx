...
interface IBusinessPlanVisionOneYearProps {
  tileId: () => Id
  getData: () => Pick<
    IBusinessPlanViewData,
    | 'pageState'
...
export const BusinessPlanVisionOneYearTile = observer(
  (props: IBusinessPlanVisionOneYearProps) => {
    ...
    const getTileData = useComputed(
      ...
      { name: 'businessPlanVisionOneYearTile-getTileData' }
    )
    ...
    const getIsEditingDisabled = useComputed(
      ...
      { name: 'businessPlanVisionOneYearTile-getIsEditingDisabled' }
    )
    ...
    const getListCollection = useComputed(
      ...
      {
        name: 'businessPlanVisionOneYearTile-getListCollection',
      }
    )
        ...
        <BusinessPlanTileHeader
          ...
          renderMenuOptions={{
            ...
            goalOptions: {
              ...
              goalCustomTerm: terms.goal.singular,
              getListCollection,
            },
          }}
